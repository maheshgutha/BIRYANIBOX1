        ...
        <div className="hidden md:flex items-center gap-8">
          <div className="flex bg-white/5 p-1 rounded-full border border-white/10 mr-4">
            <button
              ...
              className={`flex items-center gap-3 px-6 py-2 rounded-full text-[10px] font-black uppercase tracking-widest transition-all ${orderType === 'pickup' ? 'bg-primary text-white shadow-xl' : 'text-white/40 hover:text-white'}`}
            >
